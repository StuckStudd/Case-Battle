...
const SILHOUETTES: Record<WeaponCategory, string[]> = {
  ...
  agent: [
    'M100 10 Q114 10 114 26 Q114 40 100 42 Q86 40 86 26 Q86 10 100 10 Z',
    'M70 94 L72 60 Q74 48 88 46 L112 46 Q126 48 128 60 L130 94 Z',
  ],
  charm: [
    'M100 8 Q110 8 110 18 Q110 28 100 28 Q90 28 90 18 Q90 8 100 8 Z M100 13 Q95 13 95 18 Q95 23 100 23 Q105 23 105 18 Q105 13 100 13 Z',
    'M98 28 L102 28 L102 44 L98 44 Z',
    'M100 44 Q124 44 124 68 Q124 92 100 92 Q76 92 76 68 Q76 44 100 44 Z',
  ],
  music: [
    'M84 22 L136 12 L136 70 Q136 82 122 82 Q110 82 110 72 Q110 62 124 62 L128 62 L128 30 L92 37 L92 80 Q92 92 78 92 Q66 92 66 82 Q66 72 80 72 L84 72 Z',
  ],
};
